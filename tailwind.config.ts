	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				'success-pulse': {
					'0%': { transform: 'scale(1)', boxShadow: '0 0 0 0 hsl(var(--success) / 0.7)' },
					'50%': { transform: 'scale(1.05)' },
					'100%': { transform: 'scale(1)', boxShadow: '0 0 0 20px hsl(var(--success) / 0)' }
				},
				'level-unlock': {
			...
			animation: {
				...
				'success-pulse': 'success-pulse 0.8s ease-out',
				'level-unlock': 'level-unlock 1s ease-out',
				'cipher-flicker': 'cipher-flicker 2s ease-in-out infinite',
